...
def emotion_detector(text_to_analyse):
    ...
    formatted_response = json.loads(url, json=myobj, headers=header)
    ...
    dominant_emotion = response_json['emotion_scores']

    return {'anger': anger_score, 'disgust': disgust_score, 'fear': fear_score,
            'joy': joy_score, 'sadness': sadness_score, 'dominant_emotion': '<name of the dominant emotion>'}
